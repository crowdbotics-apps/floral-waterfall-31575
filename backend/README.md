...
## Project Structure
    ...
    ├── floral_waterfall_31575  # Django project configurations
...
1. Clone this repo and `cd floral_waterfall_31575`
...
2. Clone this repo and `cd floral_waterfall_31575`
